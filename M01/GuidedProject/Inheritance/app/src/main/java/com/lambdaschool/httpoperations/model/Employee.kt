...
open class Employee(val name: String, val id: Int, val age: Int, val title: String) {
    val email: String = "$title$name@bigcorp.com"
...
class Officer(name:String, id: Int, age:Int, title: String, val passKey: String = "") :
    Employee(name, id, age, title) {

    fun goToBoardMeeting() {
        Log.i("Employee", "Going to board meeting")
    }

    // Override signature function so that it does not include email for Officers
