...
class ClothingItem protected constructor(colorId: Int, productName: String) : ShoppingItem(colorId, productName) {

    constructor(productName: String) : this(R.color.colorClothingItem, productName)
